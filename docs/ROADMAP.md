...
| v0.5 | いきている | 🔶 3/6 | ✅ エモート10種＋表情7種、✅ おまかせ（放置中の自動行動）、✅ **時間帯（朝昼夕夜・夜はランプが点く）**／未：家具インタラクション、ペット、スタンプ |
...
1. エモートのスタンプ化
3. **判断ゲートの計測**：月の部屋の設置家具数の中位値が1週間で8個に届くか。
   届かないなら行き先を増やすのは止めて、1部屋の密度に投資を戻す
4. L段（共有月面広場）は v1.0 のマルチプレイと同じ条件。v0.3 の数字を見てから
